# -*- coding: utf-8 -*-
"""
Skrypt rozszerzajÄ…cy workflow n8n o obsĹ‚ugÄ™ endpointĂłw summary
"""
import json
import uuid
...
def add_summary_nodes(workflow_data):
    """Dodaje nowe nody do obsĹ‚ugi summary"""

    # Pozycje dla nowych nodĂłw (kontynuacja po istniejÄ…cych)
    ...
    node_send_review_email = {
        "parameters": {
            ...
            "html": "=<p><b>Podsumowanie zmian w dokumencie zostaĹ‚o wygenerowane i czeka na TwojÄ… weryfikacjÄ™.</b></p>\n<p>Podsumowanie:</p>\n<pre>{{ $('AI Agent4').item.json.output }}</pre>\n<p><b>Aby zatwierdziÄ‡:</b></p>\n<p>1. PrzejdĹş do interfejsu edycji podsumowania</p>\n<p>2. Dokonaj ewentualnych poprawek</p>\n<p>3. ZatwierdĹş klikajÄ…c przycisk \"ZatwierdĹş\"</p>\n<p><i>System automatycznie wykryje zatwierdzenie i wyĹ›le ostateczny raport.</i></p>",
            "options": {}
        },
...
// Dodaj informacjÄ™ czy zostaĹ‚o edytowane
if (editedByUser) {
  formattedContent += `<p style="color:#ED1B2F; font-size:9pt;"><i>âš ď¸Ź Podsumowanie zostaĹ‚o zweryfikowane i poprawione przez uĹĽytkownika</i></p>`;
}

// Wygeneruj peĹ‚ny HTML maila (kopia z Code in JavaScript4)
let htmlTemplate = `
...
<td>
<p><span style="color: #009795;font-size: 12pt;"><b>DzieĹ„ dobry, zapoznaj siÄ™ z nowym aktem wewnÄ™trznym/Check out the new internal act</b></span></p>
</td>
</tr>
...
<tr><td colspan="2" style="border-bottom: 1px solid rgb(0,150,150); height: 1px; padding: 0;"></td></tr>
<tr><td><span style="color: #707173;font-size: 11pt;">Przedmiot regulacji/concerning</span></td><td style="padding-left: 15px;"><span style="color: #707173;font-size: 11pt;">w sprawie: aktualizacji OgĹ‚oszenia nr CA/TO/39 Zasady rozpatrywania reklamacji w Credit Agricole Bank Polska S.A. na tablicy ogĹ‚oszeĹ„</span></td></tr>
<tr><td colspan="2" style="border-bottom: 1px solid rgb(0,150,150); height: 1px; padding: 0;"></td></tr>
...
<tr><td colspan="2" style="border-bottom: 1px solid rgb(0,150,150); height: 1px; padding: 0;"></td></tr>
<tr><td><span style="color: #707173;font-size: 11pt;">Data wejĹ›cia w ĹĽycie/Date of entry into force</span></td><td style="padding-left: 15px;"><span style="color: #707173;font-size: 11pt;">31.10.2025</span></td></tr>
<tr><td colspan="2" style="border-bottom: 1px solid rgb(0,150,150); height: 1px; padding: 0;"></td></tr>
...
<tr><td colspan="2" style="border-bottom: 1px solid rgb(0,150,150); height: 1px; padding: 0;"></td></tr>
<tr>
<td><p><span style="color: #707173;font-size: 11pt;">SzczegĂłĹ‚owa analiza zmian</span></p></td>
...
<p><span style="color: #009795;font-size: 12pt;"><b>WiadomoĹ›Ä‡ wygenerowana automatycznie, nie odpowiadaj na niÄ… / Automatically generated message, please do not reply to it.</b></span></p>
...
return [{ json: { html: htmlTemplate, approved_summary: approvedSummary, edited: editedByUser } }];"""
    ...
    node_sticky = {
        "parameters": {
            "content": "## INTEGRACJA SUMMARY\n\n1. POST Summary to API - wysĹ‚anie podsumowania\n2. Send Review Email - mail z proĹ›bÄ… o weryfikacjÄ™\n3. Wait Before Polling - czekaj 10s\n4. Poll Summary Status - sprawdĹş status (polling)\n5. Is Summary Approved? - IF status == approved\n6. Wait 5 Seconds - czekaj jeĹ›li nie approved\n7. Get Approved Summary - pobierz zatwierdzone\n8. Merge Approved with Report - poĹ‚Ä…cz z raportem\n9. Update Email Content - aktualizuj mail\n10. Send email - wyĹ›lij finalny mail",
            "height": 656,
            "width": 1552
        },
...
def update_connections(workflow_data, new_nodes):
    """Aktualizuje poĹ‚Ä…czenia miÄ™dzy nodami"""
    ...
    # MODYFIKACJA: AI Agent4 teraz Ĺ‚Ä…czy siÄ™ z POST Summary
    # UsuĹ„ stare poĹ‚Ä…czenie AI Agent4 -> Merge2
    ...
    # HTTP Request juĹĽ jest - musimy dodaÄ‡ drugie poĹ‚Ä…czenie do Merge
    # ZnajdĹş istniejÄ…ce poĹ‚Ä…czenie HTTP Request
    if "HTTP Request" in connections:
        # Dodaj poĹ‚Ä…czenie do nowego Merge
    ...
    # USUĹ stare poĹ‚Ä…czenie Code in JavaScript4 -> Send email
    # Send email otrzymuje teraz dane z Update Email Content
    if "Code in JavaScript4" in connections:
        # Nie usuwamy caĹ‚ego poĹ‚Ä…czenia, ale moĹĽemy je pozostawiÄ‡ jako zapasowÄ… Ĺ›cieĹĽkÄ™
        pass
...
def main():
    ...
    print(f"đź“– Wczytywanie workflow z {input_file}...")
    with open(input_file, "r", encoding="utf-8") as f:
        workflow = json.load(f)

    print(f"âś¨ Dodawanie nowych nodĂłw do obsĹ‚ugi summary...")
    new_nodes = add_summary_nodes(workflow)
    workflow["nodes"].extend(new_nodes)

    print(f"đź”— Aktualizowanie poĹ‚Ä…czeĹ„...")
    ...
    print(f"đź’ľ Zapisywanie do {output_file}...")
    with open(output_file, "w", encoding="utf-8") as f:
        json.dump(workflow, f, indent=2, ensure_ascii=False)

    print(f"âś… Gotowe! Dodano {len(new_nodes)} nowych nodĂłw")
    print(f"đź“Š ĹÄ…czna liczba nodĂłw: {len(workflow['nodes'])}")
    print(f"đź“ Plik zapisany: {output_file}")

    # WyĹ›wietl listÄ™ nowych nodĂłw
    print("\nđź“‹ Dodane nody:")
